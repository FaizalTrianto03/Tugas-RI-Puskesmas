...
class PerawatPengaturanController extends GetxController {
  // Dummy data untuk week 2/3
  final RxString namaLengkap = 'Dummy Perawat'.obs;
  final RxString namaInisial = 'Dummy Perawat'.obs;
  ...
  Future<void> _logout() async {
    ...
    Get.offAllNamed(Routes.perawatLogin);
  }
}
